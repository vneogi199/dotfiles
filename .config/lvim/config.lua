...
lvim.keys.normal_mode["n"] = "nzz"         -- center screen on next result
lvim.keys.normal_mode["N"] = "Nzz"         -- center screen on previous result
lvim.keys.insert_mode["kj"] = "<Esc>"      -- go to normal mode on pressing kj
